const HeroSection = () => {
  return (
    <section className="w-full min-h-screen bg-white flex flex-col">
      {/* Contact Info Bar */}
      <div className="w-full bg-gradient-to-r from-purple-200/30 to-purple-100/30 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-8">
            {/* Social Icons */}
            <div className="flex gap-3">
              <button className="w-10 h-10 rounded-full bg-purple-400 flex items-center justify-center text-white hover:bg-purple-500 transition">
            ...
            <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 items-center">
              <input
                ...
                className="px-4 py-2 rounded-full bg-white/80 border border-purple-300 focus:outline-none focus:border-purple-400 text-sm"
                defaultValue="info@lavandamed.ru"
              />
              <a
                href="tel:+79802444401"
                className="px-4 py-2 rounded-full bg-purple-300/40 hover:bg-purple-300/60 transition text-sm font-medium"
              >
                +7 (980) 244-44-01
              </a>
              <a
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4 py-16 md:py-24">
        ...
        <div className="text-center max-w-2xl">
          ...
          <h2 className="text-5xl md:text-6xl lg:text-7xl font-serif italic text-purple-400 mb-12">
            Лаванда
          </h2>
